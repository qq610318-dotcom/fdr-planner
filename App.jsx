...
function FDRLogo({ size = 44 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
      ...
      <text x="6" y="68" fontFamily="Georgia,serif" fontSize="52" fontWeight="bold" fill="url(#rg)" letterSpacing="-3">FDR</text>
      <path d="M50 14 L51.5 18 L55 19.5 L51.5 21 L50 25 L48.5 21 L45 19.5 L48.5 18Z" fill="#c9a49a" opacity=".9"/>
      <path d="M87 34 L88 37 L91 38 L88 39 L87 42 L86 39 L83 38 L86 37Z" fill="#c9a49a" opacity=".6"/>
      <line x1="6" y1="74" x2="94" y2="74" stroke="url(#rg)" strokeWidth="1" opacity=".4"/>
    </svg>
  );
}
